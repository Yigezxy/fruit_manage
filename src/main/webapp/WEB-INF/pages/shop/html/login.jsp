...
<div class="content content-nav-base  login-content">
    ...
    <div class="login-bg">
        <div class="login-cont w1200">
            <div class="form-box">
                <%--<form action="${request.getContextPath()}/shopper/login.in" method="post">--%>
                    <%--<input type="text" name="phonenumber" >--%>
                    <%--<input type="password" name="phonenumber">--%>
                    <%--<button type="submit" >登录</button>--%>
                <%--</form>--%>
                <form class="layui-form" action="${request.getContextPath()}/shopper/shop/login.in" method="post">
                    <legend>手机号登录</legend>
                    <div class="layui-form-item">
                        <div class="layui-inline iphone">
                            <div class="layui-input-inline">
                                <i class="layui-icon layui-icon-cellphone iphone-icon"></i>
                                <input type="tel" name="phonenumber" id="phone" lay-verify="required|phone" placeholder="请输入手机号" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline veri-code">
                            <div class="layui-input-inline">
                                ...
                                <%--<input type="button" class="layui-btn" id="find"  value="验证码" />--%>
                                 <input type="password" name="password" id="pwd"  placeholder="请输入密码" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    </div>
